...
We can probe and query SNMP values using a tool such as [snmpwalk](Tools.md#snmpwalk), provided we know the SNMP read-only community string, which in most cases is "public".
